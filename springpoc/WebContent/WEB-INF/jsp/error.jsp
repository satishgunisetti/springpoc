...
<html>
  ...
  <div class="content-container shadow">
    ...
    <div class="subheader primary-text-color">
      Oops An forseen error occured, The DataBase May be down.
    </div>
    <div class="hr"></div>
    ...
    <div class="buttons-container">
      <a class="button" href="${pageContext.request.contextPath}/"><span class="fa fa-home"></span> Go To Homepage</a>
      <a class="button" href="mailto:satish.j2me@gmail.com" target="_blank"><span class="fa fa-warning"></span> Report A Problem</a>
    </div>
  </div>
</center>
    ...
    <script>
      ...
      var ep = new ErrorPage('body', "500", "background");
      ep.initialize();
